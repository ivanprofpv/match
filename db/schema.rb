...
ActiveRecord::Schema.define(version: 2023_05_31_044424) do
  ...
  create_table "player_statistics", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["achivment_id"], name: "index_player_statistics_on_achivment_id"
    t.index ["game_id"], name: "index_player_statistics_on_game_id"
